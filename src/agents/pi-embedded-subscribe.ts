...
export function subscribeEmbeddedPiSession(params: SubscribeEmbeddedPiSessionParams) {
  ...
  const stripBlockTags = (
    ...
    // Repair malformed sequences (e.g. unclosed <think> before <final>) after
    // carrying any pending tag fragment into this chunk.
    const repaired = repairMalformedReasoningTags(scanText);
